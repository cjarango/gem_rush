...
class GameScreen:
    ...
    def _handle_keydown(self, key):
        if key == pygame.K_ESCAPE:
            self.is_paused = True
        elif key == pygame.K_w: self.move_directions["up"] = 1
    ...
    def _interact(self):
        ...
        # Portal (solo si está en el tile exacto)
    ...
    def render(self):
        ...
        self.screen.blit(
            self.font.render("TAB: Inventory | E: Open Chest / Activate Portal | ESC: Pause", True, self.COLOR_TEXT),
            (10, 10)
        )
